...
<div class="wrap">
	<!-- header -->
		<div class="header">
			...
			<div class="title">
				<div>
					<span class="ChangeTitle">여행기 게시글</span>
				</div>
		 ...
		 <!--mainSidebar -->
			...
			<!--mainScreen-->
				...
				<form action="admin-trip-board.admin" class = "searchForm">
					...
					<div class="memberLists">
						...
						<form action="admin-trip-board-delete.admin" class = "deleteForm">
							<input type = "hidden" name = "page" value = "${criteria.page}">
							<input type = "hidden" name = "type" value = "${criteria.type}">
							<input type = "hidden" name = "keyword" value = "${criteria.keyword}">
						<table class="tripBoardTable">
							<thead>
			...
			<form action="admin-trip-board.admin" name = "page-form">
