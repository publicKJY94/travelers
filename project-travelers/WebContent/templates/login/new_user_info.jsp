...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/login/new_user_info.css">
...
:root { -
	...
	-bs-gradient: linear-gradient(180deg, rgba(255, 255, 255, .15),
		rgba(255, 255, 255, 0))
}
...
@font-face {
	...
	src: local("Noto Sans KR Thin"), local("NotoSans-Thin"),
		...
		format("embedded-opentype"), url(NotoSans-Thin.1da046bbe64519cf.woff)
		format("woff"), url(NotoSans-Thin.4aa099d0670b20c6.otf)
		format("opentype")
}
...
@font-face {
	...
	src: local("Noto Sans KR Light"), local("NotoSans-Light"),
		...
		format("embedded-opentype"), url(NotoSans-Light.c2d3f8b81742f5d3.woff)
		format("woff"), url(NotoSans-Light.3d6ff6e02c057144.otf)
		format("opentype")
}
...
@font-face {
	...
	src: local("Noto Sans KR Bold"), local("NotoSans-Bold"),
		...
		format("embedded-opentype"), url(NotoSans-Bold.5a27efe02f725fdf.woff)
		format("woff"), url(NotoSans-Bold.1b2fae999f55eef6.otf)
		format("opentype")
}
...
<link rel="stylesheet"
	href="./위시빈 ㅣ 150만개의 진짜 여행정보 정보입력창_files/styles.c7b57fc6541fbb59.css"
	media="all" onload="this.media=&#39;all&#39;">
<noscript>
	<link rel="stylesheet" href="styles.c7b57fc6541fbb59.css">
</noscript>
</head>
<body>
	...
	<div id="wrap">
		...
		<form action="${pageContext.request.contextPath}/joinOk.user">
			<input type="hidden" name="identification" value="${email}">
					...
					<form novalidate="" class="">
						...
						<dl class="inner">
							...
							<dd class="di_flex wid03">
								<div>
									<select formcontrolname="birthYear" name="birthday"
										class="selbox"><option value="">연도</option>
								...
								<div>
									<select formcontrolname="birthMonth" name="birthday"
										class="selbox">
								...
								<div>
									<select formcontrolname="birthDay" name="birthday"
										class="selbox"><option value="">일</option>
						...
						<dl class="inner">
							...
							<dd>
								...
								<input type="hidden" class="gender" name="gender" value="">
									<button type="button" class="gender_btn active" value="남자">남자</button>
									<button type="button" class="gender_btn" value="여자">여자</button>
									<button type="button" class="gender_btn" value="선택안함">선택안함</button>
								</div>
							</dd>
						</dl>
						<dl class="inner phone_field">
							...
							<dd>
								<div>
									<select formcontrolname="country_code" name="country"
										id="select" class="selbox"><option value="82"
											class="">대한민국 +82</option>
						...
						<section class="terms_wrap">
							...
							<p class="inner">
								<input id="terms_all" name="terms_all" type="checkbox"
									class="chbox"><label for="terms_all"> 위시빈 약관에
									모두 동의합니다. </label>
							</p>
...
<script src="${pageContext.request.contextPath}/static/js/login/new_user_info.js">>
